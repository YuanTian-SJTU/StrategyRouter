...
from bin_packing.bin_packing_utils import datasets
...
if __name__ == '__main__':
    ...
    bin_packing_or3 = {'OR3': datasets['OR3']}
    ...
    generate_plots(
        ...
        run_time=run_time,
        filename='strategy_scores_bin_packing.png'
    )
